...
setUp(){
  ...
  sl.registerLazySingleton<MakeDriverOnlineUseCase>(() => MakeDriverOnlineUseCase(driverRepository: sl()));
  ...
  // controller
  sl.registerLazySingleton<TripController>(() => TripController(getTripRequestUseCase: sl(),selectTripUseCase: sl()));
